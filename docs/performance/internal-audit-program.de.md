...
=== ":material-lightning-bolt: Schnell (~1 Std.)"
    ...
    **ISO 9001 Abschnitt 9.2** | **Verantwortlich:** QMR
    ...
    Vollständige QMS-Abdeckung über 12 Monate.
    ...
    | A-02 | 5.1-5.3 | Führung, Politik, Rollen |
    ...
    | **Beobachtung** | Empfohlene Maßnahme |
...
=== ":material-book-open-variant: Wesentlich (~3 Std.)"
    ...
    **ISO 9001 Abschnitt 9.2** | **Verantwortlich:** QMR
    ...
    | Audit Nr. | Abschnitte | Geprüfte Prozesse | Auditor | Status |
    |:---------:|:----------:|----------------------|:-------:|:------:|
    | A-01 | 4.1-4.4 | Kontext, Geltungsbereich | _[Name]_ | ☐ |
    | A-02 | 5.1-5.3 | Führung, Politik, Rollen | _[Name]_ | ☐ |
    ...
    | **Beobachtung** | Potenzielles Risiko | Empfohlene Maßnahme |
    | **Verbesserungsmöglichkeit** | Vorschlag | Optional |
...
=== ":material-book-open-page-variant: Vollständig"
    ...
    **Nächste Überprüfung:** TT.MM.JJJJ
    ...
    ```mermaid
    graph LR
        A["Jahresplan<br/>(Risikobasiert)"] --> B["Vorbereitung<br/>(Checkliste,<br/>Terminplanung)"]
        B --> C["Eröffnungs-<br/>besprechung"]
        C --> D["Audit durchführen<br/>(Interviews,<br/>Nachweispr.)"]
        D --> E["Abschluss-<br/>besprechung"]
        E --> F["Auditbericht<br/>(Feststellungen,<br/>Beobachtungen)"]
        F --> G["Korrektur-<br/>maßnahmen<br/>(bei Festst.)"]
        G --> H["Nachverfolgung &<br/>Wirksamkeits-<br/>prüfung"]
        H --> I["Bericht an<br/>Management-<br/>bewertung"]
        style A fill:#1a5276,color:#fff
        style D fill:#196f3d,color:#fff
        style F fill:#e67e22,color:#fff
