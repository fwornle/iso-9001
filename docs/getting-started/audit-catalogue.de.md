...
=== ":material-lightning-bolt: Schnell (~1 Std.)"
    ...
    > **Geltungsbereich:** DDD-Einheit — Werkzeuge für AD/ADAS Datenengineering, Speicherung, Simulation und Reprocessing.
    ...
    | Nr. | Wahrscheinliche Auditorfrage | Kernpunkte für Ihre Antwort |
    |-----|------------------------------|----------------------------------|
    | **4.1** | Was macht Ihre Abteilung? | DDD: Datenengineering-, Simulations- und Reprocessing-Tools für AD/ADAS-Ingenieure |
    ...
    | **5.2** | Können Sie mir Ihre Qualitätspolitik zeigen? | Ausgedruckt bereithalten! Zuverlässig, skalierbar, sicher; kontinuierliche Verbesserung; datengetrieben |
    | **6.1** | Wie identifizieren und managen Sie Risiken? | Risikoregister, 5x5-Matrix, quartalsweise Überprüfung, jedes Risiko hat Verantwortlichen. 2-3 Beispiele nennen |
    | **6.2** | Was sind Ihre Qualitätsziele? | Verfügbarkeit >= 99,5%, MTTR < 4h, NPS >= 40, null Datenintegritätsvorfälle |
    | **7.2** | Wie stellen Sie Kompetenz sicher? | Kompetenzmatrix, strukturierte Einarbeitung (30-60-90), Schulungspläne |
    | **8.3** | Wie steuern Sie Design & Entwicklung? | SDLC: Anforderungen -> ADRs -> Implementierung -> Code Review (2 Prüfer) -> Test -> Staging -> Prod |
    | **9.2** | Führen Sie interne Audits durch? | Ja, Jahresprogramm, geschulte unabhängige Auditoren, Ergebnisse in Managementbewertung |
    | **10.2** | Wie behandeln Sie Nichtkonformitäten? | Eindämmen -> Ursache (5-Why) -> Korrektur -> Wirksamkeit prüfen (30/60/90 Tage) |
    ...
    2. **Zeigen statt erzählen.** Jira, Confluence, Grafana, Git offen haben
...
=== ":material-book-open-variant: Wesentlich (~3 Std.)"
    ...
    |-----|----------------------|-----------------|
    | 4.1.1 | **Was macht Ihre Abteilung?** | DDD-Einheit: Werkzeuge für Datenengineering, Simulation, Reprocessing für AD/ADAS-Ingenieure |
    ...
    | 4.2.1 | **Wer sind Ihre interessierten Parteien?** | AD/ADAS-Ingenieure, Management, Regulierungsbehörden, Cloud-Anbieter, InfoSec. Ref: [Stakeholder-Register](../qms-framework/stakeholder-register.md) |
    ...
    | Nr. | Typische Auditorfrage | Antworthinweise |
    |-----|----------------------|-----------------|
    | 5.1.1 | **Wie zeigt das Management Engagement?** | Quartalsweise Managementbewertung, Qualitätspolitik-Freigabe, Qualitätsbudget |
    | 5.2.1 | **Können Sie Ihre Qualitätspolitik zeigen?** | Ausgedruckt! Ref: [Qualitätspolitik](../qms-framework/quality-policy.md) |
    | 5.3.1 | **Wer ist für das QMS verantwortlich?** | QMR [Name], berichtet an Unit Lead. Ref: [RACI-Matrix](../qms-framework/raci-matrix.md) |

    ## Abschnitt 6: Planung

    | Nr. | Typische Auditorfrage | Antworthinweise |
    |-----|----------------------|-----------------|
    | 6.1.1 | **Wie managen Sie Risiken?** | Risikoregister, 5x5-Matrix, quartalsweise Review, Verantwortlicher + Maßnahmen. Ref: [Risikoregister](../planning/risk-register.md) |
    | 6.2.1 | **Was sind Ihre Qualitätsziele?** | Verfügbarkeit >= 99,5%, MTTR < 4h, NPS >= 40, null Datenintegritätsvorfälle. Ref: [Qualitätsziele](../planning/quality-objectives.md) |

    ## Abschnitt 7: Unterstützung

    | Nr. | Typische Auditorfrage | Antworthinweise |
    |-----|----------------------|-----------------|
    | 7.2.1 | **Wie stellen Sie Kompetenz sicher?** | Kompetenzmatrix, Einarbeitung (30-60-90), Jahrespläne. Ref: [Kompetenzmatrix](../support/competency-matrix.md) |
    ...
    | Nr. | Typische Auditorfrage | Antworthinweise |
    |-----|----------------------|-----------------|
    | 9.1.1 | **Was messen Sie?** | Verfügbarkeit, Reaktionszeiten, Fehlerraten, Deploy-Frequenz, NPS, Testabdeckung |
    | 9.2.1 | **Führen Sie interne Audits durch?** | Ja, Jahresprogramm, unabhängige geschulte Auditoren. Ref: [Internes Auditprogramm](../performance/internal-audit-program.md) |
    | 9.3.1 | **Wie oft ist Managementbewertung?** | Quartalsweise + jährlich umfassend. Ref: [Managementbewertung](../performance/management-review.md) |

    ## Abschnitt 10: Verbesserung

    | Nr. | Typische Auditorfrage | Antworthinweise |
    |-----|----------------------|-----------------|
    | 10.2.1 | **Wie behandeln Sie Nichtkonformitäten?** | Eindämmen -> Ursache (5-Why) -> Korrektur -> Wirksamkeit prüfen -> Lessons Learned. Ref: [CAPA-Protokoll](../improvement/capa-log.md) |
    ...
    1. **Ehrlich sein.** Niemals Nachweise erfinden
    2. **Zeigen statt erzählen.** Systeme offen haben
    3. **Beim Thema bleiben.** Nur beantworten, was gefragt wird
    4. **STAR-Methode:** Situation -> Aufgabe -> Aktion -> Resultat
...
=== ":material-book-open-page-variant: Vollständig"
    ...
    | Nr. | Typische Auditorfrage | Antworthinweise |
    |-----|----------------------|-----------------|
    | 8.4.1 | **Wie bewerten und wählen Sie externe Anbieter aus?** | „Cloud-Anbieter werden gemäß der Unternehmensbeschaffung ausgewählt. Für zusätzliche Werkzeuge/Bibliotheken bewerten wir anhand von: Sicherheitslage, Lizenzkompatibilität, Community-Gesundheit, Leistungs-Benchmarks und Unternehmens-InfoSec-Freigabe. Wir pflegen eine Liste zugelassener Anbieter/Werkzeuge." |
    ...
    | 8.5.3 | **Wie gehen Sie mit Kundeneigentum (Daten) um?** | „Fahrdaten aus Flottenfahrzeugen werden als sensibles Gut behandelt. Wir folgen der organisationsweiten Datenklassifizierung. Der Zugriff ist rollenbasiert (RBAC). Die Datenaufbewahrung folgt gesetzlichen Anforderungen. Wir verändern keine Quelldaten — Reprocessing erzeugt neue abgeleitete Datensätze mit vollständiger Herkunftsdokumentation." |
    ...
    | 9.2.2 | **Wie wählen Sie Auditoren aus und stellen die Objektivität sicher?** | „Auditoren sind in ISO 9001-Auditierung geschult. Sie auditieren nicht ihre eigene Arbeit. Wir rotieren Auditoren und können Auditoren aus anderen Organisationseinheiten hinzuziehen, um die Unabhängigkeit sicherzustellen." |
