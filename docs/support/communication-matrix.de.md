...
=== ":material-lightning-bolt: Schnell (~1 Std.)"
    ...
    **ISO 9001 Abschnitt 7.4** | **Verantwortlich:** QMR
    ...
    | Was | Wann | Von/An | Wie |
    |-----|------|--------|-----|
    | Daily Standup | Täglich | Team | MS Teams |
    | Sprint Review | Alle 2 Wochen | Team an Stakeholder | Besprechung |
    | Sprint Retrospektive | Alle 2 Wochen | Team | Miro |
    | All-Hands (inkl. Qualitätsmetriken) | Monatlich | Unit Lead an alle | Besprechung |
    ...
    | Störungsmeldung | Sofort | Bereitschaft an Team | PagerDuty + Slack |
...
=== ":material-book-open-variant: Wesentlich (~3 Std.)"
    ...
    **ISO 9001 Abschnitt 7.4** | **Verantwortlich:** QMR
    ...
    |-----|-------|------|-----|-----|-----|
    | Daily Standup | Synchronisation, Blocker | Täglich (15 Min.) | Team | Team | MS Teams |
    ...
    | Team-Leads-Sync | Übergreifende Abstimmung | Wöchentlich | Leads | Unit Lead | Besprechung |
    | All-Hands | Updates, Qualitätsmetriken | Monatlich | Unit Lead | Alle | Besprechung |
    ...
    | Störungsmeldung | Sofort | Bereitschaft | Kunden | Slack + E-Mail |
    | Roadmap | Quartalsweise | PO | Stakeholder | Präsentation |
...
=== ":material-book-open-page-variant: Vollständig"
    ...
    **Nächste Überprüfung:** TT.MM.JJJJ
    ...
    ## 3. Externe Kommunikation (an andere Organisationseinheiten)
    ...
    | Auditergebnisse (an Unternehmens-QM) | Über QMS-Status berichten | Jährlich | QMB | Unternehmens-QM | Formeller Bericht | Auditzusammenfassung |
