...
=== ":material-lightning-bolt: Schnell (~1 Std.)"
    ...
    **ISO 9001 Abschnitt 7.2** | **Verantwortlich:** Team Leads + HR
    ...
    |----------|------------|----------|
    | ISO 9001 QMS-Bewusstsein | Alle | Jährlich + Einarbeitung |
    | Sicherheitsbewusstsein | Alle | Jährlich (Pflicht) |
    | Datenschutz (DSGVO) | Alle | Jährlich (Pflicht) |
    | Interner Auditor | Ausgewählte | Nach Bedarf |
...
=== ":material-book-open-variant: Wesentlich (~3 Std.)"
    ...
    **ISO 9001 Abschnitt 7.2** | **Verantwortlich:** Team Leads + HR
    ...
    |----------|------------|--------|----------|
    | ISO 9001 QMS-Bewusstsein | Alle | Workshop | Jährlich + Einarbeitung |
    | ISO 26262 Werkzeugqualifizierung | QA, Tech Leads | Extern | Nach Bedarf |
    | Cloud-Zertifizierung | DevOps, Data Eng | Online | Jährlich |
    | Sicherheitsbewusstsein | Alle | E-Learning | Jährlich (Pflicht) |
    | Datenschutz (DSGVO) | Alle | E-Learning | Jährlich (Pflicht) |

    ## Kompetenznachweise
    - Ausbildung: Zeugnisse (HR-System)
    - Schulungen: Zertifikate (SuccessFactors)
    - Erfahrung: Projektzuweisungen
    - Bewertung: Jährliche 1:1-Gespräche
