...
=== ":material-lightning-bolt: Schnell (~1 Std.)"
    ...
    **ISO 9001 Abschnitt 6.1** | **Verantwortlich:** QMR | **Überprüfung:** Quartalsweise

    ## Risikobewertung: 5x5-Matrix

    | Bewertung | Stufe | Maßnahme |
    |:---------:|:-----:|------------|
    | 1-4 | Niedrig | Akzeptieren und überwachen |
    | 5-9 | Mittel | Mindern |
    | 10-15 | Hoch | Aktive Minderung erforderlich |
    | 16-25 | Kritisch | Sofortmaßnahme, eskalieren |

    ## Top-Risiken

    | ID | Risiko | Bewertung | Stufe | Gegenmaßnahme |
    |----|--------|:---------:|:-----:|----------------|
    | R-001 | Single Point of Failure Daten-Ingestion | 15 | Hoch | Redundante Pfade, automatisches Failover |
    | R-002 | Schlüsselpersonenabhängigkeit Simulation | 16 | Kritisch | Cross-Training, Runbooks |
    | R-004 | Datenleck bei Fahrdatenspeicherung | 10 | Hoch | Verschlüsselung, RBAC, Pen-Tests |
    | R-005 | Regulierungsänderung | 12 | Hoch | Regulierungsmonitoring |
...
=== ":material-book-open-variant: Wesentlich (~3 Std.)"
    ...
    **ISO 9001 Abschnitt 6.1** | **Verantwortlich:** QMR | **Überprüfung:** Quartalsweise
    ...
    | ID | Risiko | W | A | Bew. | Stufe | Verantwortlich | Gegenmaßnahme | Status |
    |----|--------|:-:|:-:|:----:|:-----:|----------------|----------------|--------|
    | R-001 | Single Point of Failure Daten-Ingestion | 3 | 5 | 15 | Hoch | _[Name]_ | Redundante Pfade, Failover | In Arbeit |
    | R-002 | Schlüsselpersonenabhängigkeit | 4 | 4 | 16 | Kritisch | _[Name]_ | Cross-Training, Runbooks | In Arbeit |
    | R-003 | Cloud-Kostenüberschreitung | 3 | 3 | 9 | Mittel | _[Name]_ | FinOps, Kostenalarme | Überwachung |
    | R-004 | Datenleck Fahrdaten | 2 | 5 | 10 | Hoch | _[Name]_ | Verschlüsselung, RBAC | In Arbeit |
    | R-005 | Regulierungsänderung | 3 | 4 | 12 | Hoch | _[Name]_ | Monitoring, modularer Ansatz | Überwachung |
    ...
    | R-008 | Talentabwanderung | 4 | 3 | 12 | Hoch | _[Name]_ | Vergütung, Lernbudget | Laufend |

    ## Chancenregister

    | ID | Chance | Bew. | Verantwortlich | Status |
    |----|--------|:----:|----------------|--------|
    | O-001 | Neue GPU-Instanzen für Simulation | 16 | _[Name]_ | Evaluierung |
    | O-002 | SimaaS für Partner-OEMs | 10 | _[Name]_ | Vorgeschlagen |
